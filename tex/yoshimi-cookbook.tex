...
% Installing the resources needed for the cookbook

\input{cookbook_install}
...
\input{cookbook_drums}

% Conversion of MIDI Tunes for Yoshimi

\input{cookbook_conversions}

% Odds and ends

\input{cookbook_notes}
...
\label{sec:summary}
   ...
   Also sign up at yoshimi@freelists.org!
